...
<?php else : ?>
    <div class="tablecontainer">
        <table border="0" cellspacing="5" cellpadding="5">
            <tbody><tr>
                    <td><b>FILTRO PER DATA</b></td></tr>
                <tr><td>DATA Inizio:</td>
                    <td><input type="date" id="min1" name="min"></td>
                </tr>
                <tr>
                    <td>DATA Fine:</td>
                    <td><input type="date" id="max1" name="max"></td>
                </tr>
            </tbody></table>
        </br>
                    ...
                    <tr>
						...
						<td>
							<a href="?p=ricevuta&id=<?=$r['id']?>">
								<i class="fa fa-file-text-o" aria-hidden="true"> Apri </i>
							</a>
						</td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).ready(function () {
			...
			if(Date.parse(fromm) > Date.parse(to)){
				alert("nooooooooo!!!")
				return false;
			}
		}
